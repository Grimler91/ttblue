...
TTBLUE_FILE_NOTIFICATION    = 0x00b50000
TTBLUE_FILE_GPS_STATUS      = 0x00020001
TTBLUE_FILE_HOSTNAME1       = 0x00020002
TTBLUE_FILE_HOSTNAME1       = 0x00020003
TTBLUE_FILE_GOLF_MANIFEST   = 0x00b00000
TTBLUE_FILE_STEP_BUCKET     = 0x00b10000
TTBLUE_FILE_GOLF_SCORECARDS = 0x00940000
v1_files = {
    'hostname'       : 0x00020002,
